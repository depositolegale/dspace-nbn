...
import org.dspace.identifier.NbnIdentifierProvider;
            ...
            AuthorizeException
    {
        ...
        if (buttonPressed.equals("submit_approve"))
        {
            ...
            if (handle != null)
            {
                ...
                DCValue[] dcv =item.getMetadata("dc","identifier","nbn",Item.ANY);
                String NewNBN ="No-NBN";
                
                if ( dcv != null && dcv.length > 0) {
                
                    	
            if (dcv[0].value.equals("nbn") )
            {
            
                NewNBN = NbnIdentifierProvider.register(handle); 
                item.clearMetadata("dc","identifier","nbn",Item.ANY);
                item.addMetadata("dc","identifier","nbn",null,NewNBN);
                item.update();
                ...
                request.setAttribute("nbn", NewNBN);
